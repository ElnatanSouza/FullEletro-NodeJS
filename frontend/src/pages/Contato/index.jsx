            ...
            <div className="container-fluid mt-5">
                ...
                <form className="form-group" onSubmit={registerCommment}>
                    ...
                    <h4 className="contato">
                        Nome Completo:
                        <input id="fale_form" className="nome form-control mt-2 mb-3" type="text" name="nome" value={name} onChange={event => setName(event.target.value)} placeholder="Digite aqui seu nome" required />
                        Email:
                    ...
                    {comentario.map(element => {
                        return (
                            <div key={element.id} className="card mt-5 shadow w-50">
                                <p> <b>Data: </b>{formatDia(element.dia)}</p> <br />
